...
<jsp:include page="main_top.jsp"></jsp:include>
    ...
    <!-- 여기에 본문 넣으시면 됩니다. -->
				...
				<c:choose>
				 <c:when test="${log.auth eq 'pm'|| log.auth eq '매니저' }">
				<div class="container">
                    <div class="view-mail-list sm-res-mg-t-30">
                        ...
                        <div class="mail-ads mail-vw-ph">
                            <p class="first-ph"><b>Subject: </b></p><input name="subject" class="form-control" placeholder="제목을 입력하세요." value="${mail.mem_name } 님 사원 정보입니다" readonly/s>
                        ...
                        <div class="view-mail-atn">
						      <p>${mail.mem_name } 님 안녕하세요!</p>
						      <p>회원정보 송부드립니다.</p>
						      <p>메일 확인 후 임시 비밀번호를 변경해 주세요.</p>
                            <textarea name="content" rows="10" class="form-control" placeholder="내용을 입력하세요." style="display:none;"> 
						      ${mail.mem_name } 님 안녕하세요!
						      아이디 : ${mail.mem_no }  비밀번호 : ${mail.mem_pass } 입니다.
						     </textarea>
                        </div>
                    ...
                    <div class="view-mail-list sm-res-mg-t-30">
                        ...
                        <div class="vw-ml-action-ls text-right mg-t-20">
                            <div class="btn-group ib-btn-gp active-hook nk-email-inbox">
                                <button class="btn btn-default btn-sm waves-effect" id="insBtn"><i class="notika-icon notika-next"></i> 발송 </button>
