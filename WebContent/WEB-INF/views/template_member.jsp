...
<jsp:include page="main_top.jsp"></jsp:include>
                                ...
                                <tbody>
								  <c:forEach var="member" items="${memlist}">
								      <tr>
								        ...
								        <td>${member.dname}</td>
								        <td>${member.pr_title}</td>
								        <td>${member.mem_name}</td>
								        <td>${member.auth}</td>
								        <td>${member.pr_sdate}</td>
								        <td>${member.pr_edate}</td>
								           <td><button class="normal"  style='font-size:10px;' 
										        id = "${member.mem_no}" >메일 발송</button> 
								      </tr>
								    </c:forEach>
                                </tbody>
                            </table>
    ...
    <br>
	     ...
	     <jsp:include page = "template_member2.jsp"></jsp:include>
...
<!-- Start Footer area-->
   ...
   <script src="${path}/a00_com/js/data-table/jquery.dataTables.min.js"></script>
		<script src="${path}/a00_com/js/data-table/data-table-act.js"></script>
    <!-- main JS
		============================================ -->
    <script src="js/main.js"></script>
	<!-- tawk chat JS
