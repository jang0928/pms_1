        ...
        <div class="container">
            <div class="row">
				...
				<ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro" style='width : 100%,'>
    				  <li  style='width : 14%'><a data-toggle="tab"onclick="location.href='${path}/pjtlist.do'"><i class="feather" data-feather="bar-chart"></i> 일정 관리</a>
                        </li>
                        <li style='width : 14%'><a data-toggle="tab" onclick="location.href='${path}/risklist.do'"><i class="feather" data-feather="briefcase"></i> 리스크 관리</a>
                        </li>
                        <li style='width : 14%'><a data-toggle="tab" onclick="location.href='${path}/board.do?method=list'"><i class="feather" data-feather="alert-triangle"></i> 내 업무 관리</a>
                        </li>
                        <li style='width : 14%'><a data-toggle="tab" onclick="location.href='${path}/memlist.do'"><i class="feather" data-feather="list"></i> 사원 리스트</a>
                        </li>
                        <li style='width : 14%'><a data-toggle="tab" onclick="location.href='${path}/calendar.do?method=list'" ><i class="feather" data-feather="calendar"></i> 캘린더</a>
                        </li>                         
                    </ul>
                    </div>
                    <!--  style='margin:auto'-->
