                        ...
                        <div class="cmp-int mg-t-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                            <select class="selectpicker" name = "risk_list">
												<option value = "조직 리스크(Organizational Risk)">조직 리스크(Organizational Risk)</option>
												<option value = "기술적 리스크(Technical Risk)">기술적 리스크(Technical Risk)</option>
												<option value = "외부 리스크(External Risk)">외부 리스크(External Risk)</option>
											</select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11 col-md-10 col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <div class="nk-int-st cmp-int-in cmp-email-over">
                                            <input name="mem_name" class="form-control" placeholder="작성자" />
                                        </div>
                                    </div>
                                </div>
                            </div>
