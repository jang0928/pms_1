...
// board.z02_util.FileDownloadViewer (객체 저장을 위해)
public class FileDownloadViewer extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, 
		...
		// 3. server에 있는 파일을 client에 전달하기 위한 response객체 속성 선언
		...
		// 7) client에 전송된 파일은 다시 OutputSteam으로 저장 처리된.
