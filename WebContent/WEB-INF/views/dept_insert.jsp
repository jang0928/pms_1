   ...
   $(document).ready(function(){
	   $("#insBtn").click(function(){
		   if($("[name = dname]").val() == ""){
			...
			if(confirm("등록하시겠습니까?")){
				$("[name=proc]").val("ins");
				$("form").attr("action", "${path}/deptInsert.do");
				$("form").submit()
				;}
                              ...
                              <div class="row">
                                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                                    <div class="cmp-int-lb cmp-int-lb1 text-right">
                                        <span style = "background-color : lightgray; font-weight : bolder; font-size : 12px;">팀 이름</span>
                                    </div>
                                </div>
                                <div class="col-lg-11 col-md-10 col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <div class="nk-int-st cmp-int-in cmp-email-over">
                                            <input type="text" class="form-control" placeholder="이름 " name="dname" />
                                        </div>
                                    </div>
                                </div>
                            </div>
