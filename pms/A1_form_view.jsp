                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro" style='width : 100%,'>
    				  <li  style='width : 14%'><a data-toggle="tab" onclick="location.href='ganttpage.jsp'" style=''><i class="feather" data-feather="bar-chart"></i> 일정 관리</a>
                        ...
                        <li tyle='width : 14%'><a data-toggle="tab" onclick="location.href='A1_calendar.jsp'" ><i class="feather" data-feather="calendar"></i> 캘린더</a>
                        </li>              
                    </ul>
                    </div>
                    <!--  style='margin:auto'-->
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="view-mail-list sm-res-mg-t-30">
                        ...
                        <div class="mail-ads mail-vw-ph">
                            <p class="first-ph"><b>보고자: </b>홍길동</p>
                            <p><b>프로젝트 기간: </b>2021.01.01 ~ 2021.06.01</p>
                            <p class="last-ph"><b>보고날짜:</b> 2021.04.01</p>
                        </div>
                       ...
                       <div class="mail-ads mail-vw-ph">
                        ...
                        <div class="vw-ml-action-ls text-right mg-t-20">
                            <div class="btn-group ib-btn-gp active-hook nk-email-inbox">
                                <button class="btn btn-default btn-sm waves-effect"><i class="notika-icon notika-next"></i> 목록으로</button>
                                <button class="btn btn-default btn-sm waves-effect"><i class="notika-icon notika-down-arrow"></i> 수정</button>
